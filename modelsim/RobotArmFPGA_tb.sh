...
#
# Script generated by Vivado on Sun Dec 08 22:19:54 +0700 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RobotArmFPGA_tb.sh
...
#
# Usage        : RobotArmFPGA_tb.sh
#                RobotArmFPGA_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RobotArmFPGA_tb.sh [-reset_run]
#                RobotArmFPGA_tb.sh [-reset_log]
#                RobotArmFPGA_tb.sh [-help]
#
...
#                script (type 'RobotArmFPGA_tb.sh -help' for more information).
#
...
# script info
echo -e "RobotArmFPGA_tb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RobotArmFPGA_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RobotArmFPGA_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RobotArmFPGA_tb.sh [-help]\n\
Usage: RobotArmFPGA_tb.sh [-step]\n\
Usage: RobotArmFPGA_tb.sh [-lib_map_path]\n\
Usage: RobotArmFPGA_tb.sh [-reset_run]\n\
Usage: RobotArmFPGA_tb.sh [-reset_log]\n\
Usage: RobotArmFPGA_tb.sh [-keep_index]\n\
Usage: RobotArmFPGA_tb.sh [-noclean_files]\n\n\
